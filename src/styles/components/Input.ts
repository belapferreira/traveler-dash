...
const Container = styled.div<IInputProps>`
  ...
  padding: 2.4rem;
  border-radius: ${(props) => (props.type === 'top' ? '1.6rem 1.6rem 0 0' : props.type === 'bottom' ? '0 0 1.6rem 1.6rem' : '1.6rem')};
  border: 1px solid var(--shapes-02);
  border-top: ${(props) => (props.type === 'bottom' ? '0' : '1px solid var(--shapes-02)')};
