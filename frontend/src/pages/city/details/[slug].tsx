...
import { getLocalsByCity, ILocalParams } from '@/services/local.service';
...
function CityDetail({ city, locals }: ICityDetail) {
  ...
  const Icon = categoryIcon(
    localHighlighted[0] === undefined ? '' : localHighlighted[0].category,
  );

  // Count of categories
  function countCategories(category: string) {
    const categories = locals.filter((local) => local.category === category);
          ...
          <section id="details">
            ...
            <div id="city-data">
              <div className="card">
                ...
                <div className="data">
                  <strong>{countCategories('Pontos turísticos')}</strong>
              ...
              <div className="card">
                ...
                <div className="data">
                  <strong>{countCategories('Comidas e bebidas')}</strong>
              ...
              <div className="card">
                ...
                <div className="data">
                  <strong>{countCategories('Eventos organizados')}</strong>
